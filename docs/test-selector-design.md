# Testing Selector Guide 

## Overview 
This project use standard `data-testid` attributes for automation testing (Playwright, Cypress, etc.). This ensures reliable, maintainable test selectors. 
...
- `data-testid="button-username-field"`
...
- **Avoid implementation details** (don't use class names, IDs)
...
<button {...getTestId('button', 'loin', 'submit')}>
   Login
</button>
...
- [ ] Document if the selector is complex
